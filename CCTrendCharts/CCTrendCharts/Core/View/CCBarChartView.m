...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        // 组合条形图渲染器
        _dataRenderer = [[CCBarDataChartRenderer alloc] initWithViewHandler:self.viewPixelHandler transform:self.transformer DataProvider:self];
